...
def partitionQS(tab,start,end):
    ...
    i=start #ustawiamy licznik liczbmniejczych od pivot,#
...
def repairHeap(tab,start,end):
    ...
    #wykonujemy do momentu aż rozic nie ma co najmniej 1 dziecka#
...
def insertionSort(n):
    for i in range(1,len(n)):
        ...
        # i bezpośrednio na prawo od nas jest skopiowany element od nas większy#
        n[j+1]=insVal
